...
SINGLY LINKED LIST:
Singly linked list contain nodes.
A SLL whose nodes contain two fields-
An integer value and a link to the next node or the address of the next memory location